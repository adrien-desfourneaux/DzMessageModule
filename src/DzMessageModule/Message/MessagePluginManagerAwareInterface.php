...
/**
 * Fichier de source pour l'interface MessagePluginManagerAwareInterface.
 *
 ...
 *
 * Interface pour les classes connaissant le MessagePluginManager.
 *
 * @category Source
 * @package  DzMessageModule\Message
 * @author   Adrien Desfourneaux (aka Dieze) <dieze51@gmail.com>
...
interface MessagePluginManagerAwareInterface
{
     ...
     *
     * @param MessagePluginManager $messages Nouveau gestionnaire.
     *
     * @return MessagePluginManagerAwareInterface
     */
